...
<section class="content-header">
    <ol class="breadcrumb">
      ...
      <li class="active">Penilaian Pelanggan</li>
    </ol>
  </section>
  <!-- Main content -->
      ...
      <div class="col-md-12">
        ...
        <div class="box">
          <div class="box-body">
            ...
            <a href="{{url('perhitungan/calculate')}}" class="margin-bottom-2 btn btn-primary btn-sm btn-rounded btn-fw">Perhitungan MWP</a>
          </div>
          <!-- /.box-body -->
        </div>
        <!-- /.box -->
