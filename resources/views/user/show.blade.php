      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <br>
              ...
              <a  class="margin-bottom-2 btn btn-primary btn-sm btn-rounded btn-fw" href="{{route('user.edit',$user->id)}}" data-toggle="tooltip" data-placement="bottom" title="ubah data">Edit</a>
