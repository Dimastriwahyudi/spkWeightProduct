...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="{{url('home')}}" class="navbar-brand"><b>spk </b>Weighted Product </a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="{{Route('kandidat.index')}}">Alternatif</a></li>
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div><a href="{{Route('user.index')}}" class="btn btn-default btn-block btn-flat">Data User</a></div>
  ...
  <footer class="main-footer">
    <div class="text-center container">
      <strong>DimasOrys &copy; <?php echo date("Y"); ?></strong>
    </div>
    <!-- /.container -->
  </footer>
</div>
